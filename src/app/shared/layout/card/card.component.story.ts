  ...
  .add('none-perfect image', () => ({
    ...
    props: {
      data: cardProps({
        ...
        image: {
          src:
            'https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fimages.mentalfloss.com%2Fsites%2Fdefault%2Ffiles%2F502507-iStock-513942824.jpg%3Fresize%3D767x516&f=1&nofb=1',
          alt: 'panda'
        }
      }),
      showVideo: action('show video'),
